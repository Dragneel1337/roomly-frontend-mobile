...
type NavChevronDirection = "left" | "right";

type NavChevronIconProps = {
  direction?: NavChevronDirection;
  height?: number;
  style?: ViewStyle;
};

/** Figma chevron (#E7F3FF + offset shadow). Rotate 180° for “next”. */
export function NavChevronIcon({ direction = "left", height = 32, style }: NavChevronIconProps) {
  ...
  return (
    <View
      style={[
        styles.wrap,
        direction === "right" ? styles.rotateRight : null,
        style,
      ]}
    >
